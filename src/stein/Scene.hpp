...
class Scene {
    struct ObjectInstance {
        ...
        ObjectInstance(size_t objectId, size_t shaderId, GLuint textureId0, GLuint textureId1,  GLuint textureId2, const glm::mat4& transformation, const Color&color) :
            objectId(objectId), shaderId(shaderId), transformation(transformation), color(color), textureId0(textureId0),  textureId1(textureId1), textureId2(textureId2){
        }
    };
    ...
    GLuint defaultTextureID2; // Default shaderID for drawn elements
...
public:
    ...
    void setDrawnObjectTextureID2(GLuint indexDrawnObject, GLuint textureID);
    ...
    void setDefaultTextureID2(GLuint id);
